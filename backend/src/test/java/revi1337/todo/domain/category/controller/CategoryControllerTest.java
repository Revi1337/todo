...
class CategoryControllerTest {
    ...
    void create() throws Exception {
        given(categoryCommandService.save(any(), any()))
    ...
    void findAll() throws Exception {
        given(categoryQueryService.findAll()).willReturn(List.of(
    ...
    void update() throws Exception {
        given(categoryCommandService.update(eq(1L), any(), any()))
    ...
    void update_notFound_returns404() throws Exception {
        given(categoryCommandService.update(eq(999L), any(), any()))
    ...
    void deleteById() throws Exception {
        willDoNothing().given(categoryCommandService).deleteById(1L);
