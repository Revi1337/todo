  ...
  return (
    <div className="flex flex-col gap-6 h-full pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Category Stats */}
        <div className="bg-card/50 p-6 rounded-[24px] border border-border/50 shadow-sm md:col-span-1 hover:-translate-y-1 transition-transform backdrop-blur-sm">
        ...
        {/* Weekly Trend */}
        <div className="bg-card/50 p-6 rounded-[24px] border border-border/50 shadow-sm hover:-translate-y-1 transition-transform backdrop-blur-sm">
      ...
      {/* Monthly Trend */}
      <div className="bg-card/50 p-6 rounded-[24px] border border-border/50 shadow-sm flex-1 hover:-translate-y-1 transition-transform backdrop-blur-sm">
